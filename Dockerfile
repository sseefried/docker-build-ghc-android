...
run echo "deb http://ftp.uk.debian.org/debian wheezy main" > /etc/apt/sources.list
run echo "deb-src http://ftp.uk.debian.org/debian wheezy main" >> /etc/apt/sources.list
